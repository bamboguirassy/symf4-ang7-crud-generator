...
import { Resolve, CanActivate, CanLoad } from '@angular/router';
...
export class <?= $entity_class_name ?>ListSecureService implements Resolve<<?= $entity_class_name ?>Model[]>, CanActivate {
  canActivate(route: import("@angular/router").ActivatedRouteSnapshot, state: import("@angular/router").RouterStateSnapshot): boolean | import("@angular/router").UrlTree | import("rxjs").Observable<boolean | import("@angular/router").UrlTree> | Promise<boolean | import("@angular/router").UrlTree> {
    return this.<?= $entity_twig_var_singular ?>Srv.isListingAllowed();
  }
  resolve(route: import("@angular/router").ActivatedRouteSnapshot, state: import("@angular/router").RouterStateSnapshot) {
    return this.<?= $entity_twig_var_singular ?>Srv.findAll().pipe(map(data => {
      ...
      catchError(error => {
        ...
        return of({ <?= $entity_twig_var_plural ?>: null, error: message });
      }))
  }
